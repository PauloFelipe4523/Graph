...
namespace TrabalhoGrafos
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            graph.StarNode.AddVertices(new Node(false, "01"), 81);
            graph.StarNode.AddVertices(new Node(false, "02"), 123);
            graph.StarNode.AddVertices(new Node(true, "03"), 64);
            graph.StarNode.AddVertices(new Node(false, "04"), 82);

            //nó 01
            var node_01 = graph.StarNode.Vertices.Find(x => x.NodeTO.NameNode.Equals("01")).NodeTO;
            node_01.AddVertices(new Node(true, "05"), 12);
            node_01.AddVertices(new Node(false, "06"), 1);
            ...
            node_02.AddVertices(new Node(true, "07"), 19);
            ...
            node_03.AddVertices(new Node(true, "08"), 76);
            ...
            node_05.AddVertices(new Node(false, "09"), 32);
            node_05.AddVertices(new Node(false, "10"), 2);
            ...
            node_06.AddVertices(new Node(false, "11"), 88);
            ...
            node_07.AddVertices(new Node(true, "12"), 9);
            ...
            node_09.AddVertices(graph.EndNode, 63);
            ...
            node_11.AddVertices(graph.EndNode, 72);
            ...
            node_12.AddVertices(graph.EndNode, 34);
